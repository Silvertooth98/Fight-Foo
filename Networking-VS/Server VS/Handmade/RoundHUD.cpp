...
RoundHUD::RoundHUD()
{
	...
	m_playerRoundText.SetText(std::to_string(m_playerWins));
	...
	m_opponentRoundText.SetText(std::to_string(m_opponentWins));
}
...
bool RoundHUD::Draw()
{
	m_playerRoundText.Draw(400, 50);
	m_roundCountSeparatorText.Draw(450, 50);
	m_opponentRoundText.Draw(500, 50);
