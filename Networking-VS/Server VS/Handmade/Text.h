...
- NEW: Added a destructor to destroy final texture which was causing a memory leak!
- NEW: Added a copy ctor so that we have deep copies when object is copied in Menu/Score!
